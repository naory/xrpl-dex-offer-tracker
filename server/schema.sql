...
CREATE TABLE offers (
    ...
    taker_gets_currency VARCHAR(42) NOT NULL,
    taker_gets_issuer VARCHAR(64),
    taker_gets_value NUMERIC(38,18) NOT NULL,
    taker_pays_currency VARCHAR(42) NOT NULL,
    taker_pays_issuer VARCHAR(64),
    taker_pays_value NUMERIC(38,18) NOT NULL,
    price NUMERIC(38,18) GENERATED ALWAYS AS (CASE WHEN taker_gets_value = 0 THEN NULL ELSE taker_pays_value / taker_gets_value END) STORED,
    flags INTEGER,
